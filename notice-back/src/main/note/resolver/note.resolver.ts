...
export class NoteResolver {
  ...
  @Subscription(() => NoteEntity, { name: 'noteChanged',filter:(payload,variables)=> payload.noteChanged.startdate ===variables.id})
  noteChanged(@Args({ name: 'id', type: () => Int }) id: number) {
    console.log("Your data is:",id, "in subscription");
